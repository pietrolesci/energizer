...
class ActiveLearningCallback(Callback):
    ...
    def on_pool_batch_start(self, estimator: ActiveLearningStrategy, model: _FabricModule, batch: Any, batch_idx: int) -> None:
        return self.on_batch_start(RunningStage.POOL, estimator, model, batch, batch_idx)

    def on_pool_batch_end(
        self, estimator: ActiveLearningStrategy, model: _FabricModule, output: BATCH_OUTPUT, batch: Any, batch_idx: int
    ) -> None:
        return self.on_batch_end(RunningStage.POOL, estimator, model, output, batch, batch_idx)

    def on_pool_epoch_start(self, estimator: ActiveLearningStrategy, model: _FabricModule) -> None:
        return self.on_epoch_start(RunningStage.POOL, estimator, model)

    def on_pool_epoch_end(
        self, estimator: ActiveLearningStrategy, model: _FabricModule, output: EPOCH_OUTPUT, metrics: METRIC
    ) -> None:
        return self.on_epoch_end(RunningStage.POOL, estimator, model, output, metrics)

    def on_active_fit_start(self, estimator: ActiveLearningStrategy, datastore: Datastore) -> None:
        ...

    def on_active_fit_end(self, estimator: ActiveLearningStrategy, datastore: Datastore, output: Any) -> None:
        ...

    def on_round_start(self, estimator: ActiveLearningStrategy, datastore: Datastore) -> None:
        ...

    def on_round_end(self, estimator: ActiveLearningStrategy, datastore: Datastore, output: ROUND_OUTPUT) -> None:
        ...

    def on_query_start(self, estimator: ActiveLearningStrategy, model: _FabricModule, datastore: Datastore) -> None:
        ...

    def on_query_end(
        self, estimator: ActiveLearningStrategy, model: _FabricModule, datastore: Datastore, indices: list[int]
    ) -> None:
        ...

    def on_label_start(self, estimator: ActiveLearningStrategy, datastore: Datastore) -> None:
        ...

    def on_label_end(self, estimator: ActiveLearningStrategy, datastore: Datastore) -> None:
        ...
...
class Timer(_Timer, ActiveLearningCallback):
    ...
    def on_active_fit_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
    ...
    def on_round_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
    ...
    def on_query_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
    ...
    def on_label_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
    ...
    def on_pool_epoch_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
    ...
    def on_pool_batch_end(self, estimator: ActiveLearningStrategy, *args, **kwargs) -> None:
